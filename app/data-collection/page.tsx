  ...
  return (
    <main className="min-h-screen bg-[#f7fafc] px-5 py-10 text-[#102c48]">
      <article className="mx-auto max-w-3xl rounded-[28px] bg-white p-6 shadow-sm sm:p-10">
        ...
        <h1 className="mt-3 text-3xl font-black tracking-[-.04em]">识别质量改进计划及数据采集授权说明</h1>
        ...
        <div className="mt-8 space-y-7 text-[15px] leading-7 text-[#102c48]/82">
          ...
          <section>
            ...
            <p className="mt-2">撤回后，我们会停止生成和上传新的识别样本，并清理设备上尚未上传的待处理样本。已经上传的样本不会因撤回自动立即删除，会按照本说明中的保存期限处理；如需提前删除，可以联系 eTMF 王开发团队提出申请。你可以在之后重新打开本说明并再次明确授权参加计划。注销账号时，相关账号资料、文件元数据和识别样本将按照<Link className="font-bold text-[#356b16] underline" href={sitePath('/privacy')}>《隐私政策》</Link>处理。</p>
          </section>
          <section>
            ...
            <p className="mt-2">如果采集字段、使用目的、查阅范围、服务商或保存期限发生重大变化，我们会更新本说明并在必要时重新征得你的明确同意。新的授权不会自动追溯适用于此前已经收集的样本。</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="mt-2">如需了解本计划的采集范围、撤回当前授权、删除已上传识别样本、注销账号或反馈安全问题，请联系 eTMF 王开发团队：<a className="font-bold text-[#356b16] underline" href={`mailto:${contactEmail}`}>{contactEmail}</a>。为保护账号安全，我们可能要求进行必要的身份核验。</p>
          </section>
        </div>
